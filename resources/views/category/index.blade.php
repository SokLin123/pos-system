<x-app-layout>
    <section class="section " >
        <div class="d-flex flex-wrap col-md-12 align-items-center justify-content-between px-4 mb-4">
            <h4 class="mb-3">categorys List</h4>
            <div>
                <button class="btn btn-primary icon add-list" id="toggleButton" data-original-title="Add category">
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                <div class="d-flex align-items-center list-action">
                                    <button class="btn icon btn-success me-2 edit" data-toggle="tooltip" data-placement="top" data-id="{{ $category->id }}" title="Edit">
                            ...
                            <div class=" form col-md-6 col-12 mx-auto mt-3">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form form-vertical" method="POST" action="/category/update/${response.category.id}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control" placeholder="category Name" name="category_name" value="${response.category.name}" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="date" class="form-control" name="expire_date" value="${response.category.code}" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="number" step="0.01" class="form-control" name="buying_price" value="${response.category.node}" required>
                                                                </div>
                                                            </div>
                                                        </div>
